...
#define rw_data_prepare()               write_cmd(0x0022)
...
static void LCD_FSMCConfig(void)
{
    ...
    Timing_read.FSMC_AddressSetupTime = 1;             /* 地址建立时间  */
    ...
    Timing_write.FSMC_DataSetupTime = 5;                /* 数据建立时间  */
...
//	    write_reg(0x07,0x0033);
	...
	else if( deviceid ==0x1505)
	{
       ...
       //Power On
		...
		write_reg(0x0013,0x0000);
		delay(100);
		write_reg(0x0010,0x17b0);
		write_reg(0x0011,0x0037);
		delay(100);
		write_reg(0x0012,0x0138);
		delay(100);
		write_reg(0x0013,0x1700);
		write_reg(0x0029,0x000d);
		delay(100);
		write_reg(0x0020,0x0000);
		write_reg(0x0021,0x0000);
       // Set gamma
		write_reg(0x0030,0x0001);
		write_reg(0x0031,0x0606);
		write_reg(0x0032,0x0304);
		write_reg(0x0033,0x0202);
		write_reg(0x0034,0x0202);
		write_reg(0x0035,0x0103);
		write_reg(0x0036,0x011d);
		write_reg(0x0037,0x0404);
		write_reg(0x0038,0x0404);
		write_reg(0x0039,0x0404);
		write_reg(0x003c,0x0700);
		write_reg(0x003d,0x0a1f);
		// Set Gram aera
		write_reg(0x0050,0x0000);
		write_reg(0x0051,0x00ef);
		write_reg(0x0052,0x0000);
       ...
       // Paratial display
		...
		write_reg(0x0092,0x0000);
		write_reg(0x0093,0x0003);
		write_reg(0x0095,0x0101);
		write_reg(0x0097,0x0000);
		write_reg(0x0098,0x0000);
       // Plan Control
		write_reg(0x0007,0x0021);
		delay(100);
		write_reg(0x0007,0x0031);
		delay(100);
